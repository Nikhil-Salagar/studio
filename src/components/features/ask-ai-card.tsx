    ...
    <Card>
      <CardHeader>
        <div className="flex items-center gap-3">
            ...
            <CardTitle className="font-headline text-2xl">Ask the AI Assistant</CardTitle>
        </div>
        <CardDescription>Get an instant, AI-powered answer to your question.</CardDescription>
      </CardHeader>
      <CardContent>
