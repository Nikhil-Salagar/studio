...
import { Home, BarChart3, Sprout, Users, Landmark, Sparkles } from 'lucide-react';
        ...
        <div className="bg-card/80 backdrop-blur-lg border border-primary/20 shadow-lg rounded-full">
            ...
            {navItems.map((item) => {
                ...
                <Link
                    ...
                    href={item.href}
                    className={cn(
                    'flex flex-col items-center justify-center text-center gap-1 p-2 rounded-full transition-colors duration-200',
