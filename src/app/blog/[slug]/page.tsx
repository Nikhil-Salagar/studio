...
export async function generateMetadata(
  ...
  const metadataMap: {[key: string]: Metadata} = {
    'revolutionizing-agriculture-with-ai': {
        ...
        keywords: ['AI in Agriculture', 'NS Agri AI', 'Smart Farming', 'AgriTech', 'Precision Farming'],
    ...
    'smart-crop-selection-with-ai': {
        ...
        keywords: ['Crop Selection', 'AI Farming', 'NS Agri AI', 'Data-Driven Agriculture', 'Yield Optimization'],
    ...
    'ai-powered-disease-detection': {
        ...
        keywords: ['Plant Disease Detection', 'AI Diagnostics', 'Crop Health', 'NS Agri AI', 'Mobile Farming'],
    ...
    'fertilizer-planning-made-easy': {
        ...
        keywords: ['Fertilizer Planner', 'Nutrient Management', 'Precision Agriculture', 'NS Agri AI', 'Soil Health'],
    ...
    'ai-for-sustainable-farming': {
        ...
        keywords: ['Sustainable Agriculture', 'Green Farming', 'Eco-Friendly Farming', 'NS Agri AI', 'AI Technology'],
    ...
    'weather-forecasting-for-farmers': {
        ...
        keywords: ['Farm Weather', 'AI Weather Alerts', 'Climate Smart Agriculture', 'NS Agri AI', 'Risk Management'],
    ...
    'connecting-farmers-with-ai': {
        ...
        keywords: ['Farmer Community', 'Agricultural Advice', 'AI Assistant', 'NS Agri AI', 'Knowledge Sharing'],
    ...
    'the-roi-of-agritech': {
        ...
        keywords: ['AgriTech ROI', 'Farm Profitability', 'Smart Farming Investment', 'NS Agri AI', 'Cost-Benefit'],
    ...
    'data-driven-farming-decisions': {
        ...
        keywords: ['Data-Driven Farming', 'Precision Agriculture', 'Farm Management', 'NS Agri AI', 'Analytics'],
    ...
    'ai-in-water-management': {
        ...
        keywords: ['Water Management', 'Smart Irrigation', 'AI Agriculture', 'NS Agri AI', 'Resource Conservation'],
    ...
    'market-price-insights-with-ai': {
        ...
        keywords: ['Market Prices', 'Farm Income', 'Agri-Business', 'NS Agri AI', 'Mandi Rates'],
    ...
    'the-role-of-ai-in-soil-health': {
        ...
        keywords: ['Soil Health', 'AI Agronomy', 'Sustainable Soil Management', 'NS Agri AI', 'Regenerative Agriculture'],
    ...
    'overcoming-farming-challenges-with-ai': {
        ...
        keywords: ['Farming Challenges', 'AI Solutions', 'Climate Resilience', 'Pest Management', 'NS Agri AI'],
    ...
    'a-deep-dive-into-ns-agri-ai-features': {
        ...
        keywords: ['NS Agri AI Features', 'App Tour', 'Farming App', 'AgriTech Platform', 'AI tools'],
    ...
    'getting-started-with-ns-agri-ai': {
        ...
        keywords: ['NS Agri AI Guide', 'How to Use Farming App', 'Beginner Farming', 'App Setup', 'First Steps'],
    ...
    'the-impact-of-ai-on-small-farms': {
        ...
        keywords: ['Small-Scale Farming', 'AI for Smallholders', 'Empowering Farmers', 'NS Agri AI', 'Accessible Tech'],
    ...
    'ai-and-pest-management': {
        ...
        keywords: ['Pest Management', 'IPM', 'AI Pest Control', 'Sustainable Farming', 'NS Agri AI'],
    ...
    'future-of-farming-in-your-hands': {
        ...
        keywords: ['Future of Farming', 'AgriTech Revolution', 'AI in Agriculture', 'NS Agri AI', 'Farming Innovation'],
    ...
    'financial-planning-for-farmers': {
        ...
        keywords: ['Farm Finance', 'Expense Tracking', 'Agricultural Loans', 'NS Agri AI', 'Farm Profitability'],
    ...
    'from-seed-to-harvest-with-ai': {
        ...
        keywords: ['Crop Lifecycle', 'Farming Stages', 'Seed to Harvest', 'AI Farming Assistant', 'NS Agri AI'],
